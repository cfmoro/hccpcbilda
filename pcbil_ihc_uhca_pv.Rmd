...
distances <- c("uncentered", "correlation", "euclidean","manhattan") # , 
for(aDistance in distances) {
  pvresult <- pvclust(imputedMatrix, method.dist=aDistance, method.hclust="average", nboot=1000) # 1000 for test, 10000 for final results
  plot(pvresult)
