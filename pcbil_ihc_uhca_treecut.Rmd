...
```{r}
pcbilDataImputed$cluster <- mycl
table(pcbilDataImputed$cluster)
table(pcbilDataImputed[pcbilDataImputed$cluster == 1, 28])
pcbilDataImputed[pcbilDataImputed$cluster == 26, 28]
```
