...
hccpcbil_pca_output <- paste(myWorkDirectory, "hcc-pcbil_FDATA_ANALYSIS/r/output/pca/imputed_hccpcbil_PCA_output.csv", sep="")
```
...
while(outCont <= 2) {
  ...
  if(outCont == 2) {
    ...
    titleInit <- "PCBIL"
    hccpcbil_pca_output <- paste(myWorkDirectory, "hcc-pcbil_FDATA_ANALYSIS/r/output/pca/imputed_pcbil_PCA_output.csv", sep="")
